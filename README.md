...
Although I can probably get around it by modifying `code_gen.hpp` slightly, I have to work and modify how arrays are made now, which would require A LOT of refactoring.
