...
namespace occult {
    ...
    private:
        ...
        bool type_args_have_generic_params(const std::vector<std::vector<token_t>>& type_args) const;
        std::string mangle_type_token_sequence(const std::vector<token_t>& tokens) const;

        std::string instantiate_generic_struct(const std::string& template_name, const std::vector<std::vector<token_t>>& concrete_type_args);
        std::string mangle_generic_struct_name(const std::string& template_name, const std::vector<std::vector<token_t>>& concrete_type_args) const;

        void instantiate_generic_function(const std::string& template_name, const std::vector<std::vector<token_t>>& concrete_type_args);
