...
class codegen {
    ...
    template <typename RegT, std::size_t RegSize> class register_pool {
      ...
      public:
        ...
        void set_stack_size_tracker(std::int32_t* ptr) {
            total_stack_size = ptr;
        }
                            ...
                            case ir_opcode::op_load: {
                                ...
                                for (std::size_t la = i + 1; la < func.code.size(); ++la) {
                                    ...
                                    // binary ops: consume 2, produce 1 → net -1
                                             ...
                                             la_op == ir_opcode::op_idiv || la_op == ir_opcode::op_imod || la_op == ir_opcode::op_addf32 || la_op == ir_opcode::op_subf32 || la_op == ir_opcode::op_mulf32 || la_op == ir_opcode::op_divf32 ||
                                             la_op == ir_opcode::op_modf32 || la_op == ir_opcode::op_addf64 || la_op == ir_opcode::op_subf64 || la_op == ir_opcode::op_mulf64 || la_op == ir_opcode::op_divf64 ||
                                             la_op == ir_opcode::op_modf64 || la_op == ir_opcode::op_cmp || la_op == ir_opcode::op_cmpf32 || la_op == ir_opcode::op_cmpf64 || la_op == ir_opcode::op_logical_and ||
                                             la_op == ir_opcode::op_logical_or || la_op == ir_opcode::op_bitwise_and || la_op == ir_opcode::op_bitwise_or || la_op == ir_opcode::op_bitwise_xor || la_op == ir_opcode::op_bitwise_lshift ||
