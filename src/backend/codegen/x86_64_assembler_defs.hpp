...
namespace occult::x86_64 {
    ...
    inline grp assembler_token_to_gpr(x86_64_instr_token tt) {
        if (assembler_token_to_gpr64.contains(tt)) return assembler_token_to_gpr64[tt];
        if (assembler_token_to_gpr32.contains(tt)) return assembler_token_to_gpr32[tt];
        if (assembler_token_to_gpr16.contains(tt)) return assembler_token_to_gpr16[tt];
        if (assembler_token_to_gpr8.contains(tt))  return assembler_token_to_gpr8[tt];
        throw std::runtime_error("token is not a gpr");
    }

    inline bool is_gpr(x86_64_instr_token tt) {
        if (assembler_token_to_gpr64.contains(tt)) return true;
        if (assembler_token_to_gpr32.contains(tt)) return true;
        if (assembler_token_to_gpr16.contains(tt)) return true;
        if (assembler_token_to_gpr8.contains(tt))  return true;

        return false;
    } 

    inline std::unordered_map<x86_64_instr_token, simd128> assembler_token_to_simd = {
        { x86_64_instr_token::xmm0,  xmm0  },
        { x86_64_instr_token::xmm1,  xmm1  },
        { x86_64_instr_token::xmm2,  xmm2  },
        { x86_64_instr_token::xmm3,  xmm3  },
        { x86_64_instr_token::xmm4,  xmm4  },
        { x86_64_instr_token::xmm5,  xmm5  },
        { x86_64_instr_token::xmm6,  xmm6  },
        { x86_64_instr_token::xmm7,  xmm7  },
        { x86_64_instr_token::xmm8,  xmm8  },
        { x86_64_instr_token::xmm9,  xmm9  },
        { x86_64_instr_token::xmm10, xmm10 },
        { x86_64_instr_token::xmm11, xmm11 },
        { x86_64_instr_token::xmm12, xmm12 },
        { x86_64_instr_token::xmm13, xmm13 },
