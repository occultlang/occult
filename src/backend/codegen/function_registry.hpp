...
/*
    this entire file was heavily written with artificial intelligence, this shit is like wizardry
   and a pinnacle of "modern C++" i hate how this looks, and i can not wait to rewrite it from
   scratch in C++26 with PROPER REFLECTION! >:(
...
How to register:
    occult::function_registry::register_function_to_ir<&func_name>(<vec_of_ir_functions>); *This is
first* occult::function_registry::register_function_to_codegen<&func_name>(<codegen_instance>);
*This is second*
*/
...
void register_function_to_ir(std::vector<occult::ir_function>& ir_functions) {
    ...
    [&]<std::size_t... Is>(std::index_sequence<Is...>) {
        (([&] {
             ...
             std::string occult_type =
                 (type_it != cpp_to_occult_type_map.end()) ? type_it->second : "unknown";
