...
void generate_pe_header() {
    ...
    // one section (.text), add an arugment for this later when we decide to add more sections
    ...
    // typicall aligned to SectionAlignment, for minimal code lets just set it to 0x200
